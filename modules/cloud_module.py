        ...
        for item in raw:
            if item.get("Status","").upper() in ("FAIL","CRITICAL","HIGH"):
                findings.append({
                    ...
                    "url":         item.get("ResourceId",""),   # schema: url field
